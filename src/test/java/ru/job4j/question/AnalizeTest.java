...
public class AnalizeTest {
    ...
    @Test
    public void whenAllElChanged() {
        User u1 = new User(1, "A");
        User u2 = new User(2, "B");
        User u3 = new User(3, "C");
        Set<User> previous = Set.of(u1, u2, u3);
        Set<User> current = Set.of(new User(1, "AA"),
                new User(2, "BB"), new User(3, "CC"));
        assertThat(
                Analyze.diff(previous, current),
                is(new Info(0, 3, 0))
        );
    ...
    @Test
    public void when2Add1Del() {
        User u1 = new User(1, "A");
        User u2 = new User(2, "B");
        User u3 = new User(3, "C");
        Set<User> previous = Set.of(u1, u2, u3);
        Set<User> current = Set.of(u1, u2, new User(4, "D"), new User(5, "E"));
        assertThat(
                Analyze.diff(previous, current),
                is(new Info(2, 0, 1))
        );
