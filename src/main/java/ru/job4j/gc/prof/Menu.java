...
public class Menu {
    ...
    public static final String ARRAY_INFO = " Мфссив создан и заполнен случайными значениями от 1 до ";
    public static final String MENU = """
            Введите 1 для создания массива.
            Введите 2, чтобы начать сортировку слиянием.
            Введите 3, чтобы начать сортировку пузырьком.
            Введите 4, чтобы начать сортировку вставкой.
