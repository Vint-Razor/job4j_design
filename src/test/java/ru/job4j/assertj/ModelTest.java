...
class ModelTest {
    ...
    @Test
    void checkBoolean() {
        final Model model = new Model(1, 5.255d, "name", true);
    ...
    void checkStringChain() {
        final Model model = new Model(1, 5.255d, "I am learning Java", true);
    ...
    @Test
    void checkInt() {
        final Model model = new Model(2, 5.2d, "name", true);
    ...
    void checkDoubleChain() {
        ...
        assertThat(result).isEqualTo(5.26, withPrecision(0.006d))
